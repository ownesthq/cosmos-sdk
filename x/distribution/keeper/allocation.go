...
import (
	...
	"github.com/ownesthq/cosmos-sdk/x/distribution/types"
...
func (k Keeper) AllocateTokens(
	...
	// general discussions here: https://github.com/ownesthq/cosmos-sdk/issues/2906#issuecomment-441867634
	...
	// TODO consider parallelizing later, ref https://github.com/ownesthq/cosmos-sdk/pull/3099#discussion_r246276376
	for _, vote := range previousVotes {
		validator := k.stakingKeeper.ValidatorByConsAddr(ctx, vote.Validator.Address)

		// TODO consider microslashing for missing votes.
		// ref https://github.com/ownesthq/cosmos-sdk/issues/2525#issuecomment-430838701
